...
| **`Models/data/`** | Raw datasets from Roboflow and Kaggle |
| **`Models/data/dataset_final_preprocessed/`** | **Dynamic.** Unified dataset generated by the merge pipeline |
...
**Command:** `python Models/src/yolo_dataset_preparation_pipeline.py`

* **Pre-requisite (Data Acquisition):**  
**JSON Annotations:** Download from the [AIpourlapeau GitHub Repository](https://github.com/AIpourlapeau/acne04v2) and place into `Models/data/Acne04-v2_annotations.json`
* **Raw Images:** Download the ZIP Archive from the [Kaggle Dataset](https://www.kaggle.com/datasets/karmagames/acne04-v2) and extract it directly into `Models/data/`.
...
**Command:** `python Models/src/image_preprocess.py`

* **Pre-requisite:** Complete step 5.1 so that `Models/data/Acne04_HD_YOLO_Filtered/` exists.
...
* **Output:** Creates the final augmented training bundle at `Models/data/final_dataset_preprocessed/`.
...
**Location:** `Models/src/yolo_training_kaggle.ipynb`
